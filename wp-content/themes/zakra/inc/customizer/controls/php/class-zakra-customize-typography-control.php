...
class Zakra_Customize_Typography_Control extends Zakra_Customize_Base_Control {
	...
	public function localize_script() {
		...
		$custom_fonts_array = ( isset( $this->choices['fonts'] )
								&& ( isset( $this->choices['fonts']['standard'] ) || isset( $this->choices['fonts']['google'] ) )
								&& ( ! empty( $this->choices['fonts']['standard'] ) || ! empty( $this->choices['fonts']['google'] ) )
		...
		<div class="zakra-typography-wrapper">
			...
			<div class="subsets">
				...
				<select {{{ data.inputAttrs }}}
						id="zakra-typography-subsets-{{{ data.id }}}"
